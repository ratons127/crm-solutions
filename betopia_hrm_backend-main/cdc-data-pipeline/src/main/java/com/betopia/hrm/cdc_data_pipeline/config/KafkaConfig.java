package com.betopia.hrm.cdc_data_pipeline.config;
...
public class KafkaConfig {
    ...
    private static Logger LOG = LoggerFactory.getLogger(KafkaConfig.class.getSimpleName());
...
//        }, 3)); //Retry 3 times
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
                recoverer,
                new FixedBackOff(2000L, 3L) // Retry 3 times with 2 seconds interval
        );

...
public class SeparationPolicyDTO {
    ...
    private List<SeparationPolicyVersionDTO> previousVersion = new ArrayList<>();
    ...
    public List<SeparationPolicyVersionDTO> getPreviousVersion() {
        return previousVersion;
    }

    public void setPreviousVersion(List<SeparationPolicyVersionDTO> previousVersion) {
